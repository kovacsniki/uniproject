...
void init_entities(World* world) {
	// Kutyu
	load_model(&(world->dog), "models//dog.obj");
	world->dog.texture = load_texture("textures//dog.jpg");
	init_object(&world->dog, 50, 0);

	// Cica
	load_model(&(world->cat), "models//cat.obj");
	world->cat.texture = load_texture("textures//cat.jpg");
	init_object(&world->cat, 10, 0);

	// Szobor1
	load_model(&(world->statue1), "models//statue1.obj");
	world->statue1.texture = load_texture("textures//statue.jpg");
	init_object(&world->statue1, -120, -170);

	// Szobor2
	load_model(&(world->statue2), "models//statue2.obj");
	world->statue2.texture = load_texture("textures//statue2.jpg");
	init_object(&world->statue2, 120, -170);


	// Pad
	load_model(&(world->bench), "models//bench.obj");
	world->bench.texture = load_texture("textures//bench.jpg");
	init_object(&world->bench, -25, 160);


	// Room
	world->room.ground = load_texture("textures//ground.jpg");
	world->room.back = load_texture("textures//hatul.jpg");
	world->room.front = load_texture("textures//elol.jpg");
	world->room.left = load_texture("textures//bal.jpg");
	world->room.right = load_texture("textures//jobb.jpg");
